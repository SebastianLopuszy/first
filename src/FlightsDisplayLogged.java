...
public class FlightsDisplayLogged extends JPanel {
    ...
    private MainFrameLogged mainFrameLogged;
    public FlightsDisplayLogged(Connection c, String userSes, MainFrameLogged mainFrameLogged) {

        this.mainFrameLogged = mainFrameLogged;
